...
//
//	uint32 createShaderProgram(const SOMA_String& shaderText);
//	void setShaderUniformBuffer(uint32 shader, const SOMA_String& uniformBufferName,
//		uint32 buffer);
//	void setShaderSampler(uint32 shader, const SOMA_String& samplerName,
