...
{
	//context = SDL_GL_CreateContext((SDL_Window*) window.windowHandle);
...
uint32 OpenGLRenderDevice::createShaderProgram(const SOMA_String& shaderText)
{
...
void OpenGLRenderDevice::setShaderSampler(uint32 shader, const SOMA_String& samplerName,
...
SOMA_String OpenGLRenderDevice::getShaderVersion()
{
