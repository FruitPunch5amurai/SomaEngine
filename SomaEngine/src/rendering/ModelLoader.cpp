...
//
//
//Model* ModelLoader::loadModels(const SOMA_String& fileName)
//{
...
//		modelObject->materialIndices.push_back(model->mMaterialIndex);
//
...
//		}
//
//		modelObject->meshes.push_back(newModel);
//	}
//
...
//			SOMA_String str(texturePath.data);
//			spec.textureNames["diffuse"] = str;
//		}
//		modelObject->materials.push_back(spec);
//	}
//
//	return modelObject;
//}