...
bool ArrayBitmap::load(const SOMA_String& fileName)
{
	//int32 texWidth, texHeight, bytesPerPixel;
	//uint8* data = SOIL_load_image(fileName.c_str(), &texWidth, &texHeight, &bytesPerPixel, 4);
	//if (data == nullptr) {
	//	return false;
	//}
...
bool ArrayBitmap::save(const SOMA_String& fileName) const
{
	// TODO: Implement
	return false;
}
